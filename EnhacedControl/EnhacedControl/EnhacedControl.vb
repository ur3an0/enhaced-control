...
<Microsoft.VisualBasic.ComClass()> Public Class EnhacedControl
    ...
    Private ControlTipo As TiposControles = TiposControles.TextBox
    Private Objeto As New Object

    Private _RtoLef As RightToLeft = Windows.Forms.RightToLeft.No
    Private _Lugar As System.Drawing.Point
    ...
    ''' </summary>
    Public Property IzqdaADerecha() As RightToLeft
        Get
            Return _RtoLef
        End Get
    ...
    Public Property TextoLabel() As String
        ...
        Set(ByVal value As String)
            ...
            _Lugar = New Point(label.Width + punto.Width + 2, 2)
    ...
    'PROPIEDAD CURSOR TXT
    ''' <summary>
    ''' Establece el cursor del campo de texto
    ''' </summary>
    ...
    Public Overloads Property size() As Size
        ...
        Set(ByVal value As Size)
            ...
            If Me.Multilinea Then
                Objeto.Height = Me.Height - 2
            End If

            dato.Height = Objeto.Height
    ...
    Property NMaxCaracteres() As Integer
        Get
            Return Objeto.MaxLength
        End Get
        Set(ByVal value As Integer)
            Objeto.MaxLength = value
        End Set
    End Property
    ...
    ''' </summary>
    Property BordeCampo() As BorderStyle
        Get
            Return Objeto.BorderStyle
        End Get
        Set(ByVal value As BorderStyle)
            Objeto.BorderStyle = value
        End Set
    End Property
    ...
    Property AceptaReturn() As Boolean
        Get
            Return Objeto.AcceptsReturn
        End Get
        Set(ByVal value As Boolean)
            Objeto.AcceptsReturn = value
        End Set
    End Property
    ...
    Property AceptaTab() As Boolean
        Get
            Return Objeto.AcceptsTab
        End Get
        Set(ByVal value As Boolean)
            Objeto.AcceptsTab = value
        End Set
    End Property
    ...
    Property Multilinea() As Boolean
        Get
            Return Objeto.Multiline
        End Get
        Set(ByVal value As Boolean)
            Objeto.Multiline = value
            If value = False Then
                Me.Height = 24
            End If
        End Set
    ...
    ''' </summary>
    Property IconoInfo() As ToolTipIcon
        Get
    ...
    ''' </summary>
    Property MayusoMinus() As CharacterCasing
        Get
            Return Objeto.CharacterCasing
        End Get
        Set(ByVal value As CharacterCasing)
            Objeto.CharacterCasing = value
        End Set
    End Property
    ...
    ''' <value></value>
    ''' <returns></returns>
    ''' <remarks>Especifica el Comportamiento del control</remarks>
    Public Property TipoControl() As TiposControles
        Get
            Return ControlTipo
        End Get
        Set(ByVal value As TiposControles)
            ControlTipo = value
            CreaControl(value)
        End Set
    End Property
    ...
    'CREA CONTROL
    Private Sub CreaControl(ByVal Tipo As TiposControles)
        Select Case Tipo
            Case TiposControles.TextBox
                Objeto = CType(New TextBox, TextBox)
            Case TiposControles.ComboBox
                Objeto = CType(New ComboBox, ComboBox)
        End Select
        Objeto.location = New System.Drawing.Point(28, 1)
        Objeto.size = New System.Drawing.Size(23, 21)
    ...
    Private Sub txt_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Dim texto As String = Objeto.Text.ToString
    ...
    Private Sub foco_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles foco.GotFocus
        If val_error Then
            ...
            Objeto.Select(0, Objeto.Text.Length)
        Else
            SendKeys.Send(vbTab)
            Alt = False
        End If
    ...
    End Sub
    Private Sub dato_MouseClick(ByVal sender As Object, ByVal e As MouseEventArgs) Handles dato.MouseClick
        Objeto.Visible = True
        dato.Visible = False
        Objeto.Focus()
    End Sub
    ...
    Private Sub CambiaTamañoTxt()
        If TextCambiado Or (_size.Width < Me.Width) Then
            Objeto.Width = ((Me.Width - (label.Width + punto.Width)) - 2)
            dato.Width = Objeto.Width
            TextCambiado = False
        End If
    End Sub
